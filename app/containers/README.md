...
Also located in here are 2 special containers: `app.js` and `root_container.js`.
...
`root_container.js` is the first visual component in the app.  It is the ancestor of all other screens and components.
